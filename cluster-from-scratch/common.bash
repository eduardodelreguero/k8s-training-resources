...
# IP RANGES
#
export NODES_INTERNAL_NET=10.0.0.0/24
export SERVICE_CLUSTERIP_NET=10.20.0.0/24
export PODS_NET=10.10.0.0/16

#
# IP ADDRESSES
#

export CONTROLLER_PUBLIC_IP=172.22.200.22
export CONTROLLER_PRIVATE_IP=10.0.0.11

export WORKER0_PUBLIC_IP=172.22.200.43
export WORKER0_PRIVATE_IP=10.0.0.7

export WORKER1_PUBLIC_IP=172.22.200.47
export WORKER1_PRIVATE_IP=10.0.0.13

export KUBE_APISERVER_SERVICE_IP=10.20.0.1
export COREDNS_SERVICE_IP=10.20.0.33

export CLUSTER_DOMAIN=nova.local
