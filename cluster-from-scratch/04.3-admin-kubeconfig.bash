...
# To be run on the remote client again
...
scp root@$CONTROLLER_PUBLIC_IP:$ADMIN_CERT_OUT_PATH "$ADMIN_CERT_PATH"
scp root@$CONTROLLER_PUBLIC_IP:$KUBERNETES_CA_CERT_PATH "$ADMIN_CLUSTER_CA_PATH"
