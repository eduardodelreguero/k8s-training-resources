...
scp root@$CONTROLLER_PUBLIC_IP:$KUBE_PROXY_CERT_OUT_PATH "$KUBE_PROXY_CERT_PATH"
scp root@$CONTROLLER_PUBLIC_IP:$KUBERNETES_CA_CERT_PATH "$KUBERNETES_CA_CERT_PATH"
